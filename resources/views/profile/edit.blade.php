@extends('main.app', ['activePage' => 'profile', 'titlePage' => __('User Profile')])
@section('content')
                ...
                <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="form-horizontal">
                    ...
                    <div class="card profile">
                        <div class="card-header profile">
                            <h4 class="card-title" style="color: white">{{ __('Editar Perfil') }}</h4>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                            name="email" id="input-email" type="email" placeholder="{{ __('') }}"
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{ route('profile.password') }}" class="form-horizontal">
                    ...
                    <div class="card profile">
                        <div class="card-header profile">
                            <h4 class="card-title" style="color: white">{{ __('Cambiar contraseña') }}</h4>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <input class="form-control" name="password_confirmation"
                                            ...
                                            placeholder="{{ __('Confirma nueva contraseña') }}" value="" required />
                                    </div>
                                </div>
                            </div>
                        </div>
