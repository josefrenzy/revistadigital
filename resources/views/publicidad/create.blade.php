...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('publicidad.store') }}" class="form-horizontal"
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <label class="col-sm-2 col-form-label"
                                        for="img_publicidad">{{ __('Imagen Publicidad') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <input type="file" name="img_publicidad" class="file" accept="image/*" required>
