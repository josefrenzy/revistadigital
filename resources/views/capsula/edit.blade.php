                    ...
                    <form method="post" action="{{ route('capsula.update', $capsula['id']) }}" class="form-horizontal"
                        ...
                        <div class="card ">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <input class="form-control" input type="text" name="nombre" id="nombre"
                                                placeholder="{{ __('Nombre') }}" value="{{ $capsula->nombre }}"
                                                required />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <textarea class="ckeditor form-control"
                                                name="descripcion">{{ $capsula->descripcion }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <input type="file" name="img_capsula" class="file" accept="image/*">
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                <button type="submit" class="btn btn-primary">{{ __('Actualizar Capsula') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
