@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'post.create', 'title' => __('Material
Dashboard')])
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-sm-12" style="padding: 0 35%;background-color:rgb(211, 206, 206);">
                                        --> Datos del Abstract <-- </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-2 col-form-label"
                                            for="descripcion">{{ __('Cuerpo') }}</label>
                                        <div class="col-sm-7">
                                            {{-- descripcion del abstract --}}
                                            <div class="form-group">
                                    ...
                                    {{-- <div class="row">
                                    <label class="col-sm-2 col-form-label" for="img_abstract">{{ __('Imagen del Abstract') }}</label>
                                    <div class="col-sm-7">
                                        <div class="form-group">
                                            <input type="file" class="custom-file-input" id="customFile" name="img_abstract">
                                            <label class="custom-file-label" for="customFile">Selecciona imagen para el Abstract</label>
                                        </div>
                                    </div>
                                    </div> --}}
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                                {{-- <input type="file" name="img_abstract" class="file" accept="image/*">
                                                <div class="input-group my-3">
                                                    <input type="text" class="form-control" disabled
                                                        placeholder="Nombre del archivo" id="file" required>
                                                        <div class="invalid-tooltip">
                                                            Please provide a valid state.
                                                          </div>
                                                    <div class="invalid-tooltip">
                                                ...
                                                <label class="custom-file-label" for="customFile">Selecciona imagen
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <input type="file" class="custom-file-input2" id="customFile2"
                                                        class="file" name="img_portada" required>
